...
class RedoxRateCalculatorTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        if ob:
            ...
            self.calc_adiabatic = RedoxRateCalculator([self.rct], [self.pro], 1.031373321805404, 18.5, 1.415, -1.897, 7.5, 5,
                                                      adiabatic=True)
    ...
    def test_rate_constant(self):
        ...
        self.assertAlmostEqual(
            self.calc_adiabatic.calculate_rate_constant() / 95631480.11437328,
            1.0,
            4
        )
